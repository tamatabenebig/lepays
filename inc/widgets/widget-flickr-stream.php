<?php
	public function __construct() {
		parent::__construct(
			...
			'AT Flickr Stream',
			array(
				'description'	=> __( 'Displays your Flickr photos.', 'lepays' )
			)
		);
	}
	 ...
	 private function widget_fields() {
		$fields = array(
			...
			'flickr_id' => array (
				...
				'athemes_widgets_title'			=> __( 'Flickr ID', 'lepays' ),
				'athemes_widgets_field_type'		=> 'text'
			),
			'photo_count' => array (
				'athemes_widgets_name'			=> 'photo_count',
				'athemes_widgets_title'			=> __( 'Number of Photos', 'lepays' ),
			...
			'photo_type' => array (
				...
				'athemes_widgets_title'			=> __( 'Type (user or group)', 'lepays' ),
				'athemes_widgets_field_type'		=> 'select',
				'athemes_widgets_field_options'	=> array(
					'user' 		=> 'User',
					'group' 	=> 'Group'
			...
			'photo_display' => array (
				...
				'athemes_widgets_title'			=> __( 'Display', 'lepays' ),
				'athemes_widgets_field_type'		=> 'select',
				'athemes_widgets_field_options'	=> array(
					'latest'	=> 'Latest',
					'random' 	=> 'Random'
