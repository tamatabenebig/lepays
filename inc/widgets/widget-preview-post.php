<?php
	...
	public function __construct() {
		parent::__construct(
			...
			'AT Preview Post',
			array(
				'description'	=> __( 'A widget that shows post/page preview', 'lepays' )
			)
		);
	}
	 ...
	 private function widget_fields() {
		$fields = array(
			...
			'post_id' => array (
				...
				'athemes_widgets_title'			=> __( 'Post ID', 'lepays' ),
				'athemes_widgets_field_type'		=> 'number'
			),
			'display_title' => array (
				'athemes_widgets_name'			=> 'display_title',
				'athemes_widgets_title'			=> __( 'Show post title', 'lepays' ),
				'athemes_widgets_field_type'		=> 'checkbox'
			),
			'display_thumbnail' => array (
				'athemes_widgets_name'			=> 'display_thumbnail',
				'athemes_widgets_title'			=> __( 'Show featured image', 'lepays' ),
				'athemes_widgets_field_type'		=> 'checkbox'
			),
			'display_excerpt' => array (
				'athemes_widgets_name'			=> 'display_excerpt',
				'athemes_widgets_title'			=> __( 'Show excerpt', 'lepays' ),
				'athemes_widgets_field_type'		=> 'checkbox'
			),
			'read_more_text' => array (
				'athemes_widgets_name'			=> 'read_more_text',
				'athemes_widgets_title'			=> __( 'Read more link text', 'lepays' ),
				'athemes_widgets_description'	=> __( 'Leave empty for no link', 'lepays' ),
