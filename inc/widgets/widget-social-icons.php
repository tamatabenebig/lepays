<?php
	public function __construct() {
		parent::__construct(
			...
			'AT Social Icons',
			array(
				'description'	=> __( 'Display links to your social network profiles, enter full profile URLs', 'lepays' )
			)
		);
	}
	 ...
	 private function widget_fields() {
		$fields = array(
			...
			'widget_title' => array(
				...
				'athemes_widgets_title'			=> __( 'Title', 'lepays' ),
			...
			'twitter' => array (
				...
				'athemes_widgets_title'			=> __( 'Twitter', 'lepays' ),
				'athemes_widgets_field_type'		=> 'text'
			),
			'facebook' => array (
				'athemes_widgets_name'			=> 'facebook',
				'athemes_widgets_title'			=> __( 'Facebook', 'lepays' ),
				'athemes_widgets_field_type'		=> 'text'
			),
			'linkedin' => array (
				'athemes_widgets_name'			=> 'linkedin',
				'athemes_widgets_title'			=> __( 'LinkedIn', 'lepays' ),
				'athemes_widgets_field_type'		=> 'text'
			),
			'gplus' => array (
				'athemes_widgets_name'			=> 'gplus',
				'athemes_widgets_title'			=> __( 'Google+', 'lepays' ),
				'athemes_widgets_field_type'		=> 'text'
			),
			'pinterest' => array (
				'athemes_widgets_name'			=> 'pinterest',
				'athemes_widgets_title'			=> __( 'Pinterest', 'lepays' ),
				'athemes_widgets_field_type'		=> 'text'
			),
			'youtube' => array (
				'athemes_widgets_name'			=> 'youtube',
				'athemes_widgets_title'			=> __( 'YouTube', 'lepays' ),
				'athemes_widgets_field_type'		=> 'text'
			),
			'vimeo' => array (
				'athemes_widgets_name'			=> 'vimeo',
				'athemes_widgets_title'			=> __( 'Vimeo', 'lepays' ),
				'athemes_widgets_field_type'		=> 'text'
			),
			'flickr' => array (
				'athemes_widgets_name'			=> 'flickr',
				'athemes_widgets_title'			=> __( 'Flickr', 'lepays' ),
				'athemes_widgets_field_type'		=> 'text'
			),
			'dribbble' => array (
				'athemes_widgets_name'			=> 'dribbble',
				'athemes_widgets_title'			=> __( 'Dribbble', 'lepays' ),
				'athemes_widgets_field_type'		=> 'text'
			),
			'tumblr' => array (
				'athemes_widgets_name'			=> 'tumblr',
				'athemes_widgets_title'			=> __( 'Tumblr', 'lepays' ),
				'athemes_widgets_field_type'		=> 'text'
			),
			'instagram' => array (
				'athemes_widgets_name'			=> 'instagram',
				'athemes_widgets_title'			=> __( 'Instagram', 'lepays' ),
				'athemes_widgets_field_type'		=> 'text'
			),
			'lastfm' => array (
				'athemes_widgets_name'			=> 'lastfm',
				'athemes_widgets_title'			=> __( 'Last.fm', 'lepays' ),
				'athemes_widgets_field_type'		=> 'text'
			),
			'soundcloud' => array (
				'athemes_widgets_name'			=> 'soundcloud',
				'athemes_widgets_title'			=> __( 'SoundCloud', 'lepays' ),
				'athemes_widgets_field_type'		=> 'text'
			),
		);
