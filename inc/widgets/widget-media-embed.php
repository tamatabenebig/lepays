<?php
	...
	public function __construct() {
		parent::__construct(
			...
			'AT Media Embed',
			array(
				'description'	=> __( 'Display media (video/slideshow) widget, support many sites including YouTube, Vimeo, Flickr, etc.', 'lepays' )
			)
		);
	}
	 ...
	 private function widget_fields() {
		$fields = array(
			...
			'embed_url' => array (
				...
				'athemes_widgets_title'			=> __( 'Embed URL', 'lepays' ),
				'athemes_widgets_field_type'		=> 'text'
			),
			'embed_width' => array (
				'athemes_widgets_name'			=> 'embed_width',
				'athemes_widgets_title'			=> __( 'Embed width in pixels', 'lepays' ),
				'athemes_widgets_field_type'		=> 'number'
			),
			'embed_description' => array (
				'athemes_widgets_name'			=> 'embed_description',
				'athemes_widgets_title'			=> __( 'Description', 'lepays' ),
