...
function athemes_content_nav( $nav_id ) {
	...
	<nav role="navigation" id="<?php echo esc_attr( $nav_id ); ?>" class="<?php echo $nav_class; ?>">
		<h1 class="screen-reader-text"><?php _e( 'Post navigation', 'lepays' ); ?></h1>
	...
	<?php elseif ( $wp_query->max_num_pages > 1 && ( is_home() || is_archive() || is_search() ) ) : // navigation links for home, archive, and search pages ?>
		...
		<div class="nav-previous"><?php next_posts_link( '<span class="meta-nav"><i class="ico-left-open"></i></span> ' . __( 'archives', 'lepays' ) ); ?></div>
		<?php endif; ?>

		<?php if ( get_previous_posts_link() ) : ?>
		<div class="nav-next"><?php previous_posts_link( __( 'actualité', 'lepays' ) . ' <span class="meta-nav"><i class="ico-right-open"></i></span>' ); ?></div>
		<?php endif; ?>
...
function athemes_comment( $comment, $args, $depth ) {
	...
	<li id="comment-<?php comment_ID(); ?>" <?php comment_class(); ?>>
		<div class="comment-body">
			<?php _e( 'Pingback:', 'lepays' ); ?> <?php comment_author_link(); ?> <?php edit_comment_link( __( 'Edit', 'lepays' ), '<span class="edit-link">', '</span>' ); ?>
		</div>
	...
	<li id="comment-<?php comment_ID(); ?>" <?php comment_class( empty( $args['has_children'] ) ? '' : 'parent' ); ?>>
		<article id="div-comment-<?php comment_ID(); ?>" class="comment-body">
			<footer class="clearfix comment-meta">
				...
				<p class="comment-awaiting-moderation"><?php _e( 'Your comment is awaiting moderation.', 'lepays' ); ?></p>
				<?php endif; ?>
			</footer><!-- .comment-meta -->
...
function athemes_posted_on() {
	...
	printf( __( '<span class="posted-on">Posted on %1$s</span><span class="byline"> by %2$s</span>', 'lepays' ),
		...
		sprintf( '<span class="author vcard"><a class="url fn n" href="%1$s" title="%2$s">%3$s</a></span>',
			...
			esc_attr( sprintf( __( 'View all posts by %s', 'lepays' ), get_the_author() ) ),
